...
sap.ui.define([
	...
	return Controller.extend("cbc.co.simulador_costos.controller.Admon.Users.Perfil", {
		...
		frmLogisticPress: function(oEvent) {
			this.LogisticaDisplay = sap.ui.xmlfragment("cbc.co.simulador_costos.view.Utilities.fragments.PerfilDisplay", this);
		...
		SavePerfil: function() {
			var obj = {
				"DataPerfil": [
					{
						"perfil": this.byId("txtPerfil").getValue(),
						"modulo": this.byId("lstModulo").getValue(),
						"submodulo": this.byId("lstSubModulo").getValue(),
						"opcion": this.byId("lstOpción").getValue()
					}
				]
			};
			var json = new JSONModel(obj);
