...
sap.ui.define([
	...
	return Controller.extend("sap.ui.demo.walkthrough.controller.Admon.Users.Team", {
		...
		frmLogisticPress: function(oEvent) {
			this.LogisticaDisplay = sap.ui.xmlfragment("sap.ui.demo.walkthrough.view.Utilities.fragments.TeamDisplay", this);
