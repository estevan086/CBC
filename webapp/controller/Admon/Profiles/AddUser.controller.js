...
sap.ui.define([
	...
	return Controller.extend("cbc.co.simulador_costos.controller.Admon.Users.AddUser", {
		...
		frmLogisticPress: function(oEvent) {
			this.LogisticaDisplay = sap.ui.xmlfragment("cbc.co.simulador_costos.view.Utilities.fragments.AddUserDisplay", this);
