...
], function (Controller, JSONModel, Filter, Sorter, FilterOperator, GroupHeaderListItem, Device, Fragment) {
	"use strict";

	return Controller.extend("cbc.co.simulador_costos.controller.Admon.Profiles.ListProfiles", {
		onInit: function () {
			// Control state model
			...
			this.getRouter().getRoute("rtChListProfiles").attachPatternMatched(this._onMasterMatched, this);
		...
		onOpenViewSettings: function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "com.cliente.MasterDetail.view.ViewSettingsDialog",
					controller: this
		...
		_onMasterMatched: function () {
			...
			//this.getModel("AppProfileView").setProperty("/layout", "OneColumn");
		},
		...
		_showDetail: function (oItem) {
			...
			//this.getModel("AppProfileView").setProperty("/layout", "TwoColumnsMidExpanded");
