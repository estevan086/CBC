...
sap.ui.define([
	...
	return Controller.extend("sap.ui.demo.walkthrough.controller.DataDefault.TypeChange.GridTypeChange", {
		...
		frmLogisticPress: function(oEvent) {
			...
			this.LogisticaDisplay = sap.ui.xmlfragment("sap.ui.demo.walkthrough.view.Utilities.fragments.AdminTypeChange", this);
